...
void test_ttf2(){
  PFont f = createFont("Helvetica Bold",200);
  E.HATCH_MODE = PEmbroiderGraphics.PARALLEL;
  E.STROKE_MODE = PEmbroiderGraphics.TANGENT;
...
//E.STROKE_SPARSITY = 4;
  ...
  for (int i = 0; i < 4; i++){
    E.beginShape();
    E.vertex(x,y);
    E.quadraticVertex(x+30*s,y+30*s,x+10*s,y+50*s);
    E.quadraticVertex(x,y+50*s,x-5*s,y+45*s);
    E.quadraticVertex(x-10*s,y+40*s,x-10*s,y+30*s);
    E.quadraticVertex(x+10*s,y+20*s,x,y);
    E.endShape();
    s += 2;
    x += s*30;
  }
...
void setup(){
 ...
 E.setPath("/Users/studio/out.pec");
  PEmbroiderHatchSpine.setGraphics(E);
